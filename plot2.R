...
png(filename = "C:\\Users\\oran\\Documents\\R\\coursera\\Exploratory Data Analysis\\Week 1\\plot2.png")
#first line chart
plot(y=filtered$Global_active_power,x =filtered$datetime , type = "l",ylab = "Global active power (kilowatts)",xlab = "")
dev.off()
